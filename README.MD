...
Conseil : ajustez ces variables selon votre charge et votre topologie. Par exemple augmentez WORKER_POOL pour plus de parallélisme, ou réduisez CLAMD_RETRY si vos daemons sont instables.
